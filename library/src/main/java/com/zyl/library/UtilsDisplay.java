...
class UtilsDisplay {
	...
	static AlertDialog showUpdateAvailableDialog(final Context context, String title, String content, String btnNegative, String btnPositive, String btnNeutral, final URL apk) {
	...
	static Snackbar showUpdateAvailableSnackbar(final Context context, String content, Boolean indefinite, final URL apk) {
	...
	static void showUpdateAvailableNotification(Context context, String title, String content, URL apk, int smallIconResourceId) {
		...
		PendingIntent pendingIntentUpdate = PendingIntent.getActivity(context, 0, UtilsLibrary.intentToUpdate(context, apk), PendingIntent.FLAG_CANCEL_CURRENT);
		...
		NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
				...
				.setAutoCancel(true)
				.addAction(R.drawable.ic_info_white_24dp, context.getResources().getString(R.string.appupdater_btn_update),
						pendingIntentUpdate);
